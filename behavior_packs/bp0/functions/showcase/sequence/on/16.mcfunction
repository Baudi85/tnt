execute @e[tag="tnt_display_sponge_tnt"] ~~~ fill ~~-1~~~-3~ sealantern 0 replace coal_block
execute @e[tag="tnt_display_lucky_tnt"] ~~~ fill ~~-1~~~-3~ sealantern 0 replace coal_block
