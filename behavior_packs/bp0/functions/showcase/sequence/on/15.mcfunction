execute @e[tag="tnt_display_wither_tnt"] ~~~ fill ~~-1~~~-3~ sealantern 0 replace coal_block
execute @e[tag="tnt_display_patient_zero_tnt"] ~~~ fill ~~-1~~~-3~ sealantern 0 replace coal_block
