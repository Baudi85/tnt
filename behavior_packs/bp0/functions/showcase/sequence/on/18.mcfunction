execute @e[tag="tnt_display_miners_tnt"] ~~~ fill ~~-1~~~-3~ sealantern 0 replace coal_block
execute @e[tag="tnt_display_troll_tnt"] ~~~ fill ~~-1~~~-3~ sealantern 0 replace coal_block
