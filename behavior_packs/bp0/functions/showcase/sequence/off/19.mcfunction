execute @e[tag="tnt_display_void_eater_tnt"] ~~~ fill ~~-1~~~-3~ coal_block 0 replace sealantern
execute @e[tag="tnt_display_magnet_tnt"] ~~~ fill ~~-1~~~-3~ coal_block 0 replace sealantern
